            ...
            <div style={{ marginBottom: '12px' }}>
              ...
              {pendingRequests.map((requester) => (
                ...
                >
                  ...
                  <span style={{ color: '#666', fontSize: '12px' }}>{'⭐'.repeat(Math.min(requester.level, 10))}</span>
                  <button
            ...
            <div>
              {friends.map((friend) => (
                ...
                >
                  ...
                  <span style={{ color: '#666', marginRight: '8px' }}>{'⭐'.repeat(Math.min(friend.level, 10))}</span>
                  <button
                    className="btn btn-buy"
            ...
            <tbody>
              {leaderboard.map((farmer, i) => (
                ...
                >
                  ...
                  <td style={{ textAlign: 'right', color: '#666' }}>{'⭐'.repeat(Math.min(farmer.level, 10))}</td>
